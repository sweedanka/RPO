...
char *personalization = "myapplication-sample-app";
...
auto android_logger = spdlog::android_logger_mt("android", "myapplication_ndk");
...
Java_com_example_myapplication_MainActivity_initRng(JNIEnv *env, jclass clazz) {
