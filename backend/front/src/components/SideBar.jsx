...
import {faGlobe, faImage, faPalette, faUniversity, faUsers, faUserCircle} from "@fortawesome/free-solid-svg-icons";
        ...
        <>
            { props.expanded &&
                <Nav className={"flex-column my-sidebar my-sidebar-expanded"}>
                    ...
                    <Nav.Item><Nav.Link as={Link} to="/account"><FontAwesomeIcon icon={faUserCircle} />{' '}Мой аккаунт</Nav.Link></Nav.Item>
                </Nav>
            ...
            { !props.expanded &&
                <Nav className={"flex-column my-sidebar my-sidebar-collapsed"}>
                    ...
                    <Nav.Item><Nav.Link as={Link} to="/account"><FontAwesomeIcon icon={faUserCircle} size="2x" /></Nav.Link></Nav.Item>
                </Nav>
            }
        </>
    )
